...
HVIFThumbnailProvider::GetThumbnail(UINT cx, HBITMAP *phbmp, WTS_ALPHATYPE *pdwAlpha)
{
	...
	*phbmp = NULL;
	...
	haiku::Icon icon = haiku::IconConverter::LoadFromBuffer(fileData, haiku::FORMAT_AUTO);
	...
	std::string svgData(svgBuffer.begin(), svgBuffer.end());
